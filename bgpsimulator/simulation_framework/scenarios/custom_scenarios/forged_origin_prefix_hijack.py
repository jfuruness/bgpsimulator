...
class ForgedOriginPrefixHijack(Scenario):
    """Victim announces a prefix covered by a ROA, attacker announces the same prefix but with a forged origin ASN, bypassing ROV"""
