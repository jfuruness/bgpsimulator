...
from bgpsimulator.simulation_framework import ScenarioConfig, NonRoutedSuperprefixPrefixHijack
...
ex_config_010 = EngineRunConfig(
    ...
    diagram_desc="NonRoutedSuperprefix + Prefix Hijack with ROV simple",
    diagram_ranks=[
