...
from bgpsimulator.simulation_framework import ScenarioConfig, NonRoutedPrefixHijack
...
ex_config_008 = EngineRunConfig(
    ...
    diagram_desc="NonRoutedPrefixhijack with ROV simple",
    diagram_ranks=[
