...
from bgpsimulator.simulation_framework import ScenarioConfig, SuperprefixPrefixHijack
...
ex_config_011 = EngineRunConfig(
    ...
    diagram_desc="Superprefix + Prefix Hijack with ROV simple",
    diagram_ranks=[
