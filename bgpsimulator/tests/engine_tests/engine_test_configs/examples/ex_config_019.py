...
ex_config_019 = EngineRunConfig(
    ...
    diagram_desc="accidental route leak against OnlyToCustomersSimple. This policy sets the only_to_customers attribute specified in RFC 9234 which protects against simple route leaks",
    diagram_ranks=[
