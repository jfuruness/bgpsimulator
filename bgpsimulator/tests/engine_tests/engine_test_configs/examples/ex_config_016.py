...
ex_config_016 = EngineRunConfig(
    ...
    diagram_desc="Origin prefix hijack with pathend and BGPFull. PathEnd checks the end of the path for valid providers and is thus protected against simple origin hijacks",
    diagram_ranks=[
