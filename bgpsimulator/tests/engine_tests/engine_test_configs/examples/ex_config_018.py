...
from bgpsimulator.simulation_framework import ScenarioConfig, AccidentalRouteLeak
...
ex_config_018 = EngineRunConfig(
    ...
    scenario_config=ScenarioConfig(
        ...
        override_base_settings={
            ...
            CommonASNs.VICTIM: {Settings.PATH_END: True},
        },
    ),
    as_graph=ASGraph(graph_data),
    diagram_desc="accidental route leak against pathend simple. PathEnd checks the end of the path for valid providers so anything beyond the third AS is not protected",
    diagram_ranks=[
