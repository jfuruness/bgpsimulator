...
from bgpsimulator.as_graphs import CAIDAASGraphCollector, CAIDAASGraphJSONConverter
from bgpsimulator.shared import bgpsimulator_logger
from bgpsimulator.tests.engine_tests import DiagramAggregator
...
def pytest_configure(config):
    ...
    if not hasattr(config, "workerinput"):
        ...
        CAIDAASGraphJSONConverter().run(caida_as_graph_path=caida_path)
